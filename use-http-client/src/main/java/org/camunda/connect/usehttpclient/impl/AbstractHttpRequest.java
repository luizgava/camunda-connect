...
public class AbstractHttpRequest<Q extends HttpBaseRequest<?, ?>, R extends HttpResponse> extends AbstractConnectorRequest<R> {
  ...
  @SuppressWarnings("unchecked")
  public Q apiUseall(String apiUseall) {
    setRequestParameter(HttpBaseRequest.PARAM_NAME_API_USEALL, apiUseall);
    return (Q) this;
  }

  public String getApiUseall() {
    return getRequestParameter(HttpBaseRequest.PARAM_NAME_API_USEALL);
  }

  @SuppressWarnings("unchecked")
  public Q clientId(String clientId) {
    setRequestParameter(HttpBaseRequest.PARAM_NAME_CLIENT_ID, clientId);
    return (Q) this;
  }

  public String getClientId() {
    return getRequestParameter(HttpBaseRequest.PARAM_NAME_CLIENT_ID);
  }

  @SuppressWarnings("unchecked")
  public Q clientSecret(String clientSecret) {
    setRequestParameter(HttpBaseRequest.PARAM_NAME_CLIENT_SECRET, clientSecret);
    return (Q) this;
  }

  public String getClientSecret() {
    return getRequestParameter(HttpBaseRequest.PARAM_NAME_CLIENT_SECRET);
  }

  @SuppressWarnings("unchecked")
  public Q nomeConexaoUseall(String nomeConexaoUseall) {
    setRequestParameter(HttpBaseRequest.PARAM_NAME_NOME_CONEXAO_USEALL, nomeConexaoUseall);
    return (Q) this;
  }

  public String getNomeConexaoUseall() {
    return getRequestParameter(HttpBaseRequest.PARAM_NAME_NOME_CONEXAO_USEALL);
  }
}
